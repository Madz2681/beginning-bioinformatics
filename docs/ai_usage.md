...
Rosalind Problem #2 Continued: Asking Gemini to Solve the Problem
  Tool/model & version: Gemini
  What I asked for: I asked Gemini to solve Rosalind Problem #2. Gemini initially said my existing code was correct, so I asked it to show me how it would write the code instead.
...
Rosalind Problem #8
  ...
  What I asked for: I asked ChatGPT how to enter the alphabet for the codons, and it produced a typed-out version of the codons for me to use in the code.
  Snippet of prompt(s): "Can you give me a version of the codon table that I can copy directly into my code if I wanted to put the table into a dictionary?"
  What I changed before committing: I copied the codon table into my dictionary.
  How I verified correctness (tests, sample data): I just ran the code with the sample data Rosalind gave.
